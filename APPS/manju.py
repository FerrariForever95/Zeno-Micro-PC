...
def main(ui=None, on_exit=None):
    ...
    # Create screen
    screen = UIScreen(ui, background=color565(192, 192, 192), taskbarcolor=color565(50, 50, 50), taskbar_text='manju', taskbar_text_color=color565(255, 255, 255), on_exit=on_exit)
