...
def main(ui=None, on_exit=None):
    ...
    # Create screen
    screen = UIScreen(ui, background=color565(121, 142, 225), taskbarcolor=color565(139, 41, 20), taskbar_text='Rama', taskbar_text_color=color565(255, 255, 255), on_exit=on_exit)
